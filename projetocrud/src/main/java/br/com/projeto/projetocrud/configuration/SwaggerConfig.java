package br.com.projeto.projetocrud.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("br.com.projeto.projetocrud.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder()
				.title("API - Projeto-CRUD")
				.description("Projeto de um CRUD")
				.version("1.0.0")
				.license("Apache License Version 2.0")
				.licenseUrl("https://github.com/annysena")
				.contact(contact())
				.build();
	}

	private static Contact contact() {
		return new Contact("Anny Sena", "https://github.com/annysena", "annysena.as44@gmail.com");
	}
